...
SECRET_KEY = 'django-insecure-f$hfcjquybk)ah=-5j+i&3ltw8s%z)tzu2_teewirjv0%e^mi@'
...
MIDDLEWARE = [
    ...
    'crime_management.logincheckmiddleware.logincheckmiddleware',
]
...
AUTH_USER_MODEL="crime_management.CustomUser"
